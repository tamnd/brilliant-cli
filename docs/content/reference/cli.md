...
```
brilliant <command> [arguments] [flags]
```

Run `brilliant <command> --help` for the full flag list on any command. This
...
per operation you declare in `brilliant/domain.go`.
