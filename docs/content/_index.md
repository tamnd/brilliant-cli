---
title: "brilliant"
description: "Read public Brilliant.org wiki articles and courses"
heroTitle: "brilliant, from the command line"
heroLead: "Read public Brilliant.org wiki articles and courses One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
brilliant links <path>           # the pages it links to, each addressable
brilliant serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading brilliant by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address brilliant as
  `brilliant://` URIs and follow links across sites. See
