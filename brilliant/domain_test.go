...
// HTTP behaviour is covered in brilliant_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "brilliant://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("brilliant", "about")
	if err != nil || got.String() != "brilliant://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want brilliant://page/about", got.String(), err)
	}
}
